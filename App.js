...
const SplashScreens = () => (
  <View style={styles.splashScreen}>
    <Image
      source={require('./assets/iconlogo.png')} // Make sure to replace with your actual splash image path
...
export default function App() {
  ...
  const ConfirmationModal = ({ onClose, onContinue, onSubmit }) => (
    <Modal visible={true} transparent={true} animationType="slide">
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          <Text style={styles.modalTitle}>Confirmation</Text>
          <Text style={styles.modalText}>Do you want to continue with more questions?</Text>
          <View style={styles.modalButtonContainer}>
            <TouchableOpacity onPress={onSubmit} style={[styles.modalButton, styles.submitButton]}>
              <Text style={styles.modalButtonText}>No, Submit</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={onContinue} style={[styles.modalButton, styles.continueButton]}>
  ...
  return (
    <ScrollView contentContainerStyle={[styles.container, { backgroundColor }]}>
      {isShowSplashScreen ? <SplashScreen /> : <Text></Text>}
          ...
          {step === 1 && (
            <>
              <View style={styles.formGroup}>
                ...
                <View style={styles.ratingContainer} ClassName="d-flex flex-column">
